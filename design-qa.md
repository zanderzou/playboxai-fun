# Playbox AI Video Guide — visual QA

Checked on 2026-09-21 against the production Astro build.

- Desktop: 2561 × 1263 browser viewport inspected through the logged-in browser session.
- Mobile: 390 × 844 emulation inspected through Chrome DevTools Protocol.
- Hero image remains readable under the gradient, with the subject on the right and headline space on the left.
